import 'package:MapMarking/river_game.dart';
...
class GameOptionsPage extends StatefulWidget {
  ...
  GameOptionsPage({required this.selectedMap,required this.selectedDifficulty, required this.selectedLanguage, required this.selectedPlaces});
  @override  
...
class _GameOptionsPageState extends State<GameOptionsPage> {
  ...
  bool areAllOptionsSelected() {
    return widget.selectedMap != null &&
        widget.selectedDifficulty != null &&
        widget.selectedPlaces != null &&
      ...
      builder: (BuildContext context) {
        return AlertDialog(
          ...
          content: Text(
            ...
            "Number of Places: ${widget.selectedPlaces}\n"
                    ...
                    child: Padding(
                      ...
                      child: Column(
                        ...
                        children: [
                          ...
                          DropdownTile(
                            title: "Select Map",
                            options: ["Srilanka - Places","Srilanka - Water Bodies"],
                            selectedValue: widget.selectedMap,
                            onChanged: (value) => setState(() => widget.selectedMap = value),
                          ...
                          DropdownTile(
                            ...
                            onChanged: (value) => setState(() => widget.selectedDifficulty = value),
                            isStartGamePressed: isStartGamePressed,
                          ),
                          DropdownTile(
                            title: "Number of Places",
                            options: ["5", "10", "15","30"],
                            selectedValue: widget.selectedPlaces,
                            onChanged: (value) => setState(() => widget.selectedPlaces = value),
                            isStartGamePressed: isStartGamePressed,
                          ),
                          DropdownTile(
                            title: "Language",
                            ...
                            onChanged: (value) => setState(() => widget.selectedLanguage = value),
                            isStartGamePressed: isStartGamePressed,
                          ),
                          SizedBox(height: 16),
                          Row(
                              ...
                              ElevatedButton(
                                ...
                                onPressed: () {
                                  ...
                                  if (areAllOptionsSelected()) {
                                    // Navigate to GameApp
                                    if(widget.selectedMap == 'Srilanka - Places'){
                                      Navigator.push(
                                      context,
                                      MaterialPageRoute(
                                        builder: (context) => GameApp(
                                          Language: widget.selectedLanguage!,
                                          Map: widget.selectedMap!,
                                          level: widget.selectedDifficulty!,
                                          numOfPlaces: int.parse(widget.selectedPlaces!),
                                        ),
                                      ),
                                    );
                                    } else{
